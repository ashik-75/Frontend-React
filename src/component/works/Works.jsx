...
const Works = () => {
    ...
    direction === 'left'
      ? setCurrentSlide(
          currentSlide > 0
            ...
            : contentPortfolio.length - 1
        )
      : setCurrentSlide(
          currentSlide === contentPortfolio.length - 1 ? 0 : (curr) => curr + 1
        );
  ...
  return (
    <div className="works" id="works">
      ...
      />
      <ArrowForwardIos className="arrow right" onClick={() => handleSlide()} />
    </div>
  );
};
